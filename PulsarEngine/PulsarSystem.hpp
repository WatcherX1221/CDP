...
enum Context {
    ...
    LOLPACK_LAPS_BIN1,
    LOLPACK_LAPS_BIN2,
    LOLPACK_LAPCOUNT_BIN1,
    LOLPACK_LAPCOUNT_BIN2,
    LOLPACK_LAPCOUNT_BIN4,
    LOLPACK_LAPCOUNT_BIN8,
    LOLPACK_SPEEDMOD_BIN1,
    LOLPACK_SPEEDMOD_BIN2,
    LOLPACK_SPEEDMOD_BIN4,
    LOLPACK_SPEEDMOD_BIN8,
    LOLPACK_ROULETTE_BIN1,
    LOLPACK_ROULETTE_BIN2,
    LOLPACK_ROULETTE_BIN4,
    LOLPACK_TTITEM_BIN1,
    LOLPACK_TTITEM_BIN2,
    LOLPACK_TTITEM_BIN4,
    LOLPACK_TTITEMCOUNT_BIN1,
    LOLPACK_TTITEMCOUNT_BIN2,
