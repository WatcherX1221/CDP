...
enum BMG {
    ...
    BMG_TROPHY_INVALID = 0x2702,
    BMG_GP_RACE = 0x2703,
    BMG_CHOOSE_NEXT = 0x2704,
    BMG_RANDOM_TRACK = 0x2705,
    BMG_PERCENT_RACE = 0x2706,
    BMG_NUMBER_RACE = 0x2707,
    ...
    BMG_USERSETTINGSOFFSET = 0x60000, //user settings therefore start at 0x53000 for radio settings, 0x53700 for scrollers
